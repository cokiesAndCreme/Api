...
public class GlobalExepcionesManager extends RuntimeException{

    @ExceptionHandler(ProductoyaExiste.class)
    private ResponseEntity<String> ProductoyaExisteHandler (ProductoyaExiste ext, WebRequest webRequest){
        return new ResponseEntity<>(ext.getMessage(),HttpStatus.NOT_FOUND);
    }
